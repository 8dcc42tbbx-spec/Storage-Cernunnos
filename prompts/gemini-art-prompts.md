...
- `assets/scene_q1_odysseus.png` — Add: A weathered bronze Corinthian war helmet with a tall horsehair crest, resting on a stone ledge beside a round bronze hoplite shield and a broken spear, salt-worn ship planking underneath, faint sea-mist in the background, warm amber rim-light.
...
- `assets/scene_q3_athena.png` — Add: A wise grey owl perched atop a bronze shield and spear planted upright in stone, an olive branch draped across the shield's rim, cool moonlight with a faint divine silver glow surrounding the owl.
